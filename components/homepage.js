...
const navigation = [
  ...
  { name: 'Products', href: '#', icon: FireIcon, current: false },
            ...
            <div className="mx-auto max-w-3xl sm:px-6 lg:grid lg:max-w-7xl lg:grid-cols-12 lg:gap-8 lg:px-8">
              <div className="hidden lg:col-span-3 lg:block xl:col-span-2">
                <nav aria-label="Sidebar" className="sticky top-4 divide-y divide-gray-300">
                  ...
                  {/*          href={item.href}*/}
                  {/*          className={classNames(*/}
                  {/*              item.current ? 'border-pink-300 text-gray-900' : 'text-gray-700 hover:bg-gray-50',*/}
                  {/*              'border border-transparent group flex items-center px-3 py-2 text-sm font-medium rounded-md'*/}
                  {/*          )}*/}
                  {/*          aria-current={item.current ? 'page' : undefined}*/}
                  {/*      >*/}
                  {/*        <item.icon*/}
